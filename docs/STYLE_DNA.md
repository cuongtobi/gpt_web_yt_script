...
```text
wild state → human contact → selection → specialization → modern form
```
...
hãy để fact tạo chuyển động:

> Khi cây được chọn cho sợi dài hơn, nó bắt đầu trở nên tệ hơn cho mục đích khác.
